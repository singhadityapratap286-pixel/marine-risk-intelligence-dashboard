    ...
    <div className="bg-slate-800 rounded-xl shadow-lg p-6">
      ...
      <div className="bg-slate-900 rounded-xl p-6 border border-slate-700">
        ...
        <div className="grid grid-cols-5 gap-4 text-center">
          <div><div className="text-4xl font-bold text-cyan-400">{report.ph}</div><div>PH</div></div>
          <div><div className="text-4xl font-bold text-cyan-400">{report.turbidity}</div><div>Turbidity NTU</div></div>
          <div><div className="text-4xl font-bold text-cyan-400">{report.tds}</div><div>TDS PPM</div></div>
          <div><div className="text-4xl font-bold text-cyan-400">{report.temp}</div><div>Temp °C</div></div>
          <div><div className="text-4xl font-bold text-cyan-400">{report.mfc}</div><div>MFC</div></div>
        </div>
